...
local function constructNew_frmItemArma()
    ...
    obj.dataLink1:setField("caBonus");
    ...
    obj._e_event0 = obj.dataLink1:addEventListener("onChange",
        function (field, oldValue, newValue)
            local r=getRootSheet(sheet); if r~=nil then recalc(r); end
        end);
...
function newfrmItemArma()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmItemArma();
      end,
      function()
...
frmItemArma = _frmItemArma;
Firecast.registrarForm(_frmItemArma);
