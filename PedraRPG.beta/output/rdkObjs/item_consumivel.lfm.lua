...
local function constructNew_frmItemConsumivel()
...
function newfrmItemConsumivel()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmItemConsumivel();
      end,
      function()
...
local _frmItemConsumivel = {
    newEditor = newfrmItemConsumivel, 
    new = newfrmItemConsumivel, 
    name = "frmItemConsumivel", 
    dataType = "", 
    formType = "undefined", 
...
frmItemConsumivel = _frmItemConsumivel;
Firecast.registrarForm(_frmItemConsumivel);

return _frmItemConsumivel;
