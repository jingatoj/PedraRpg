...
local function constructNew_frmPedraItem()
    ...
    obj.label3:setText("Descrição (por nível)");
    ...
    obj.textEditor1:setField("descricaoPorNivel");
...
function newfrmPedraItem()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmPedraItem();
      end,
      function()
...
frmPedraItem = _frmPedraItem;
Firecast.registrarForm(_frmPedraItem);

return _frmPedraItem;
